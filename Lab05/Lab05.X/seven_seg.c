...
//Example -- initialize Timer1 to trigger interrupts every 1ms void init_Timer1(void) { 
TMR1 = 0x0000; //clear timer register
PR1 = xxxx; //set the period
//init interrupts 
mT1SetIntPriority(5); //group priority set to 5
mT1ClearIntFlag();
// configure for multi-vectored mode and enable system interrupt INTEnableSystemMultiVectoredInt();
